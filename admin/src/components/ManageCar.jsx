...
const StatCard = ({ title, value, icon: Icon, className = "" }) => (
    <div
        className={`${styles.gradientOrange} ${styles.rounded2xl} ${styles.statCard} ${styles.borderGray} ${styles.borderHoverOrange}
         ${className}`}
    >
        ...
        >
            ...
            <div className=' p-5'>
                ...
                <div className=' flex justify-between border-t border-gray-800 pt-4'>
                    <button
                        onClick={() => onEdit(car)}
                        className={`flex item-center ${styles.textOrange} hover:text-orange-300
                        transition-colors`}
                    >
                    ...
                    <button
                        ...
                        className={`flex item-center ${styles.textRed} hover:text-red-300
                        transition-colors`}
                    >
...
const EditModal = ({ car, onClose, onSubmit, onChange }) => {
    ...
    const handleInputChange = (e) => {
        ...
        onChange({
            ...car,
            [name]: ["year", "dailyRate", "milage", "seats"].includes(name)
                ? value === ""
                    ? ""
                    : Number(value)
                : value,
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {inputField("Daily Rate (MYR)", "dailyRate", "number", {
                                required: true,
                                min: 1,
                                step: 0.01,
                            })}
        ...
        <div className=' min-h-screen bg-gray-950 p-4 sm:p-6'>
            <div className=' relative mb-8 pt-16 text-center'>
                ...
                <p className=' text-gray-400 max-w-2xl mx-auto'>
                    Manage your car fleet efficiently. Track bookings and monitor vehicle status all in one place.
                </p>
            </div>
