...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        window.open(`https://wa.me/+61481152728?text=${whatsappMessage}`, '_blank');
    ...
    <div className={styles.container}>
        ...
        <div className={styles.content}>
            <div className={styles.titleContainer}>
                <h1 className={styles.title}>Reach Our Team</h1>
                <div className={styles.divider} />
                <p className={styles.subtitle}>
                    Any inquiries about our vehicles or to contact us out for assistance in your traveling needs.
                </p>
            </div>
                ...
                <div className={styles.formCard}>
                    ...
                    <div className='mb-4'>
                        ...
                        <p className={styles.formSubtitle}>
                            Fill out the form and our service team will get back to you promptly.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className={styles.form}>
                        ...
                        <div className='relative'>
                            ...
                            <textarea 
                                ...
                                required 
                                rows="3"
                                placeholder='Tell us more on how we could assist you...'
