...
import { ArrowRight, CheckCircle, Fuel, Users, Zap } from 'lucide-react'
        ...
        <div className={styles.container}>
            ...
            <div className={styles.headerContainer}>
                <div className={styles.premiumBadge}>
                    ...
                    <span className={styles.premiumText}>Start Your Journey</span>
                </div>

                <h1 className={styles.title}>Finest Car Collection</h1>
                <p className={styles.subtitle}>
                    Discover mind-free and fast start to your next destination with limitless comfort
                </p>
            </div>
                    ...
                    return(
                        ...
                        >   
                            ...
                            <div className={styles.priceBadge}>
                                <span className={styles.priceText}>AUD{car.price}/day</span>
                            </div>
